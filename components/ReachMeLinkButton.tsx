import type { ReachMeIcon, ReachMeLink } from "@/lib/types";
...
const icons: Record<ReachMeIcon, () => React.JSX.Element> = {
  mail: MailIcon,
  x: XIcon,
  github: GithubIcon,
...
interface ReachMeLinkButtonProps {
  link: ReachMeLink;
}

export default function ReachMeLinkButton({ link }: ReachMeLinkButtonProps) {
